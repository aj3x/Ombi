            ...
            try
            {
                ...
                if (!test)
                {
                    ...
                    {                        // Get the users to send it to
                        ...
                        var html = email.LoadTemplate(messageContent.Subject, messageContent.Message, body, customization.ApplicationUrl, customization.Logo, url);
                ...
                else
                {
                    ...
                    foreach (var a in admins)
                    {
                        ...
                        var html = email.LoadTemplate(messageContent.Subject, messageContent.Message, body, customization.ApplicationUrl, customization.Logo, unsubscribeLink);
